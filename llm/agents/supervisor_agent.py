...
prompt = ChatPromptTemplate.from_template(
    ...
    1️**stock_agent**
       - 주식 종목 코드, 포지션, 매수/매도, 잔고, 자동매매 관련 질문
       - 예: "삼성전자 매수 시점 알려줘", "내 잔고 알려줘", "005930 종목 포지션"
...
def supervisor_agent(state: Dict[str, Any]) -> Command[Literal["stock_agent", "news_agent", "rag_agent"]]:
